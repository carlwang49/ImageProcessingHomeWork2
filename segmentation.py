...
from segmentation_model.util import get_model, ensemble_predict, visualize_prediction, resize_prediction, dice_coefficient
...
def segmentation(image_path):
    ...
    for fold in range(n_splits):
        ...
        model_state_dict = torch.load(f'./segmentation_model/Result/segmentation_model_fold_{fold}.pth', map_location='cpu')
